...
public class exam2 {
    public static void main(String[] args) {
        ...
        */
        ...
        //               0   1   2   3      // B 삭제한 경우 삭제된 B 이후로 C D 한칸씩 앞으로 이동
        //              1000개의 자료가 있다는 가정에 일부 삭제/수정 하면 999이동 발생
        // 즉] 삽입이 빠르다.

        // LinkedList : 링크[h헤더][d본문][t꼬리] = 노드 기반의 리스트 배열 구조
        //                 [][ A ][B주소]    [A주소][ B ][C주소]   [B주소][ C ][D주소]   [C주소][ D ][]
        //                 // E저장한 경우   마지막 D 고리에 E주소 저장하고 E 헤더에 D 주소 저장
        //                 // B 삭제한 경우 삭제할 노드에 꼬리에 주소를 헤더노드 꼬리에 대입
