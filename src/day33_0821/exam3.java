...
public class exam3 {
    public static void main(String[] args) {
        /*
            ...
            멀티스레드 구현
                1) Runable 익명구현체   : new Runable(){ run(); }
                2) Runable 구현체  *추천 : class 클래스 implements Runable{ run() }
            ...
            * 활용처: 1) 톰캣(웹서버/SPRING) : 다수의 유저(클라이언트)가 1개의 서버에 요청시 병렬 처리 제공
                    -> 동시 다발적으로 로그인 시도/채팅 들을 병렬처리한다. 
        */
